...
function initBuffers() {
    ...
    colors = [
        [0.7, 0.7, 0.7, 1.0], // Front face
        [0.1, 0.1, 0.1, 1.0], // Back face
...
function drawScene() {
    ...
    mvPushMatrix();
    mat4.rotate(mvMatrix, degToRad(xy), [0, 0, 1]);
    mat4.rotate(mvMatrix, degToRad(xz), [1, 0, 0]);
    mat4.rotate(mvMatrix, degToRad(zy), [0, 1, 0]);
